from .Falcon_dilithium.Falcon_default_parameters import Dilithium2 as D
...
contract ETHDilithiumTest is Test {
    ZKNOX_dilithium Falcon_dilithium;
    ...
    function setUp() public {
        ...
        Falcon_dilithium = new ZKNOX_dilithium(ntt);
    }
