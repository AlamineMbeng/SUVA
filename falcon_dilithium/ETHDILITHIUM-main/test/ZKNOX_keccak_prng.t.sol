...
contract KeccakPRNGTest is Test {
    ...
    function test_keccak_prng_test_vectors() public {
        ...
        // bytes memory out_4_1 = Falcon_keccak_prng.extract(32);
        // // get a sub array
        ...
        // bytes memory out_4_2 = Falcon_keccak_prng.extract(32);
        // // get a sub array
        ...
        // bytes memory out_4_3 = Falcon_keccak_prng.extract(32);
        // // get a sub array
